...
export const About = () => {
  ...
  const backendSkills = ["Node.js", "Python", "AWS", "MySQL", "Java"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong>B.Tech in Computer Science </strong> - SRM Institute of Science and Technology
                  (2022-2026)
                </li>
                <li>
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    {" "}
                   AI Intern at Mphasis (June 2024 – July 2024){" "}
                  </h4>
                  <p>
                   Built a book recommender using collaborative filtering and Streamlit. Also explored sentiment analysis with VADER and RoBERTa
                  </p>
                </div>
